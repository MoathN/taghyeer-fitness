...
const Shop = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 34.99,
      image: "https://images.unsplash.com/photo-1595859703065-2259982784bb?q=80&w=400&auto=format&fit=crop",
    ...
    },
    {
      ...
      price: 29.99,
      image: "https://images.unsplash.com/photo-1521986329282-0436c1f1e212?q=80&w=400&auto=format&fit=crop",
    ...
    },
    {
      ...
      price: 54.99,
      image: "https://images.unsplash.com/photo-1544942733-31210ca885d3?q=80&w=400&auto=format&fit=crop",
      category: "protein",
      inStock: true,
      rating: 4.3,
      bestseller: false,
    ...
    },
    {
      ...
      price: 44.99,
      image: "https://images.unsplash.com/photo-1600618528240-fb9fc964b853?q=80&w=400&auto=format&fit=crop",
      category: "performance",
      inStock: true,
      rating: 4.1,
      bestseller: false,
    },
    {
      ...
      price: 52.99,
      image: "https://images.unsplash.com/photo-1622485482001-635ec9132be0?q=80&w=400&auto=format&fit=crop",
      category: "protein",
      inStock: true,
      rating: 4.7,
      bestseller: false,
    ...
    },
    {
      ...
      price: 28.99,
      image: "https://images.unsplash.com/photo-1579027989536-b7b1f875659b?q=80&w=400&auto=format&fit=crop",
      category: "performance",
      inStock: true,
      rating: 4.5,
      bestseller: false,
    ...
    },
    {
      ...
      price: 47.99,
      image: "https://images.unsplash.com/photo-1588515820482-15af2c16337a?q=80&w=400&auto=format&fit=crop",
      category: "protein",
      inStock: true,
      rating: 4.5,
      bestseller: false,
    },
    {
      ...
      price: 19.99,
      image: "https://images.unsplash.com/photo-1584308074357-5c43c31147d1?q=80&w=400&auto=format&fit=crop",
      category: "vitamins",
      inStock: true,
      rating: 4.8,
      bestseller: false,
    },
    {
      ...
      price: 17.99,
      image: "https://images.unsplash.com/photo-1558017487-06bf9f82613a?q=80&w=400&auto=format&fit=crop",
      category: "accessories",
      inStock: true,
      rating: 4.6,
      bestseller: false,
    ...
    },
    {
      ...
      price: 38.99,
      image: "https://images.unsplash.com/photo-1587799872345-fb58a77e4cc6?q=80&w=400&auto=format&fit=crop",
      category: "pre-workout",
      inStock: true,
      rating: 4.3,
      bestseller: false,
    },
    {
      ...
      price: 22.99,
      image: "https://images.unsplash.com/photo-1615485925763-86786288908a?q=80&w=400&auto=format&fit=crop",
      category: "vitamins",
      inStock: true,
      rating: 4.8,
      bestseller: true,
    ...
    },
    {
      ...
      price: 33.99,
      image: "https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?q=80&w=400&auto=format&fit=crop",
      category: "performance",
      inStock: true,
      rating: 4.2,
      bestseller: false,
    },
    {
      ...
      price: 26.99,
      image: "https://images.unsplash.com/photo-1550403271-2bc3f038243a?q=80&w=400&auto=format&fit=crop",
      category: "performance",
      inStock: true,
      rating: 4.6,
      bestseller: false,
    },
    {
      ...
      price: 29.99,
      image: "https://images.unsplash.com/photo-1576992125912-abd38d4eea0e?q=80&w=400&auto=format&fit=crop",
      category: "clothing",
      inStock: true,
      rating: 4.7,
      bestseller: true,
    },
    {
      ...
      price: 44.99,
      image: "https://images.unsplash.com/photo-1561654791-00316c79efa8?q=80&w=400&auto=format&fit=crop",
      category: "clothing",
      inStock: true,
      rating: 4.8,
      bestseller: true,
    },
    {
      ...
      price: 129.99,
      image: "https://images.unsplash.com/photo-1603455907637-70d743bec030?q=80&w=400&auto=format&fit=crop",
      category: "equipment",
      inStock: true,
      rating: 4.9,
      bestseller: false,
    ...
    },
    {
      ...
      price: 79.99,
      image: "https://images.unsplash.com/photo-1570939274717-7eda259b50ed?q=80&w=400&auto=format&fit=crop",
      category: "accessories",
      inStock: true,
      rating: 4.5,
      bestseller: true,
    },
    {
      ...
      price: 24.99,
      image: "https://images.unsplash.com/photo-1599447292470-41eebc4eb11d?q=80&w=400&auto=format&fit=crop",
      category: "equipment",
      inStock: true,
      rating: 4.6,
      bestseller: false,
    ...
    },
    {
      ...
      description: "Lightweight, breathable hoodie perfect for warm-ups and cool-downs.",
      price: 54.99,
      image: "https://images.unsplash.com/photo-1556306535-0f09a537f0a3?q=80&w=400&auto=format&fit=crop",
      category: "clothing",
      inStock: true,
      rating: 4.5,
      bestseller: false,
    },
    {
      ...
      price: 89.99,
      image: "https://images.unsplash.com/photo-1538807093257-eab19ad38fa3?q=80&w=400&auto=format&fit=crop",
      category: "equipment",
      inStock: true,
      rating: 4.9,
      bestseller: true,
    },
    {
      ...
      price: 15.99,
      image: "https://images.unsplash.com/photo-1604779277435-e5b8b08d0c86?q=80&w=400&auto=format&fit=crop",
      category: "accessories",
      inStock: true,
      rating: 4.3,
      bestseller: false,
    },
    {
      ...
      price: 34.99,
      image: "https://images.unsplash.com/photo-1607792246505-02e19816bc23?q=80&w=400&auto=format&fit=crop",
      category: "accessories",
      inStock: true,
      rating: 4.7,
      bestseller: false,
    },
    {
      ...
      price: 27.99,
      image: "https://images.unsplash.com/photo-1586511925558-a4c6376fe65f?q=80&w=400&auto=format&fit=crop",
      category: "protein",
      inStock: true,
      rating: 4.4,
      bestseller: false,
