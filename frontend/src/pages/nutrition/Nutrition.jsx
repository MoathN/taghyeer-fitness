        ...
        <TabsContent value="guides">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/macronutrients-101"
            >
            ...
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/pre-post-workout"
            >
              <ul className="mt-4 space-y-2 list-disc list-inside text-gymmawy-gray">
            ...
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/weight-loss"
            >
              <ul className="mt-4 space-y-2 list-disc list-inside text-gymmawy-gray">
            ...
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/muscle-building"
            >
              <ul className="mt-4 space-y-2 list-disc list-inside text-gymmawy-gray">
            ...
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/supplements-guide"
            >
              <ul className="mt-4 space-y-2 list-disc list-inside text-gymmawy-gray">
            ...
            <NutritionCard
              ...
              showButton={true}
              buttonLink="/nutrition/nutrition-myths"
            >
              <ul className="mt-4 space-y-2 list-disc list-inside text-gymmawy-gray">
        ...
        <TabsContent value="mealplans">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <MealPlanCard
              ...
              fat="70g"
              imageSrc="/img/nutrition/meal-prep-1.jpg"
              route="/nutrition/beginners-meal-plan"
            />
            ...
            <MealPlanCard
              ...
              fat="60g"
              imageSrc="/img/nutrition/meal-prep-2.jpg"
              route="/nutrition/fat-loss-meal-plan"
            />
            ...
            <MealPlanCard
              ...
              fat="80g"
              imageSrc="/img/nutrition/muscle-meal-prep.jpg"
              route="/nutrition/muscle-gain-plan"
            />
            ...
            <MealPlanCard
              ...
              fat="75g"
              imageSrc="/img/nutrition/pre-workout-nutrition.jpg"
              route="/nutrition/maintenance-plan"
            />
            ...
            <MealPlanCard
              ...
              fat="65g"
              imageSrc="/img/nutrition/protein-meal.jpg"
              route="/nutrition/vegetarian-plan"
            />
            ...
            <MealPlanCard
              ...
              fat="70g"
              imageSrc="/img/nutrition/nutrition-consultation.jpg"
              route="/nutrition/performance-plan"
            />
          </div>
...
const NutritionCard = ({ title, description, imageSrc, children, showButton, buttonLink }) => {
  return (
        ...
        {showButton && (
          <div className="mt-4">
            <Button className="w-full" asChild>
              <Link to={buttonLink}>Learn More</Link>
            </Button>
          </div>
        )}
      </CardContent>
...
const MealPlanCard = ({ title, description, calories, protein, carbs, fat, imageSrc, route }) => {
  return (
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-grow">
        ...
        <Button className="w-full" asChild>
          <Link to={route || "/contact"}>View Full Plan</Link>
        </Button>
      </CardContent>
    </Card>
  );
