  ...
  const trainers = [
    {
      ...
      profilePath: "/sarah-profile"
    },
    {
      id: 2,
      name: "Michael Rodriguez",
      specialization: "Cardio & HIIT",
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=300&h=400&auto=format&fit=crop",
        ...
        <div className="container relative">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Card className="border-primary bg-gymmawy-purple/80 shadow-lg transition-all hover:shadow-xl relative">
              ...
              <CardHeader>
                <CardTitle className="text-gymmawy-white">Plus</CardTitle>
                <div className="mt-2 text-4xl font-bold text-primary">$20<span className="text-lg font-normal text-gymmawy-gray">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2 text-gymmawy-white">
                    <MdFitnessCenter className="text-primary" /> Full gym access
                  </li>
                  <li className="flex items-center gap-2 text-gymmawy-white">
            ...
            <Card className="border-gymmawy-gray/10 bg-gymmawy-purple/80 transition-all hover:shadow-xl">
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2 text-gymmawy-white">
                    <MdFitnessCenter className="text-primary" /> Unlimited gym access + premium classes
                  </li>
                  <li className="flex items-center gap-2 text-gymmawy-white">
                    <MdRestaurant className="text-primary" /> Advanced nutrition coaching
                  </li>
                  <li className="flex items-center gap-2 text-gymmawy-white">
                    <MdPerson className="text-primary" /> Unlimited personal training sessions
                  </li>
                </ul>
              </CardContent>
              <CardFooter>
            ...
            {trainers.map((trainer) => (
              <div key={trainer.id} className="trainer-card rounded-lg overflow-hidden border border-gymmawy-gray/10">
                ...
                <div className="p-6 bg-gymmawy-purple/50">
                  ...
                  >
                    <Link to={trainer.profilePath}>View Profile</Link>
                  </Button>
                </div>
              </div>
            ))}
